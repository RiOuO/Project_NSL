...
namespace Nsl_Core.Models.Infra
{
    public class EmailHelper
	{
		public static void VerifyTeacher(TeacherVerifyDto dto)
		{
			...
			client.Credentials = new System.Net.NetworkCredential("xxxxxxxxxxxxxx@gmail.com", "jtnhllczbslabezl");
        ...
        public static void VerifyMember(Members member)
        {
            ...
            SmtpClient client = new SmtpClient();
            client.Credentials = new System.Net.NetworkCredential("xxxxxxxxxxxxx@gmail.com", "jtnhllczbslabezl");
            client.Host = "smtp.gmail.com";
            client.Port = 25;
            client.EnableSsl = true;
            client.Send(msg);
