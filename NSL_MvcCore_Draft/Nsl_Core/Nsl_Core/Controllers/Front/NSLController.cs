...
namespace Nsl_Core.Controllers.Front
{
    public class NSLController : Controller
    {
        ...
        public ActionResult FacebookRedirect(string code)
        {
            ...
            {
                client_id = "169050442808007",
                client_secret = "da9b7291dfd7b83e2eb91c1c2dd074ce",
                redirect_uri = "https://localhost:7217/NSL/FacebookRedirect",
                code = code
            });
        ...
        public IActionResult ValidGoogleLogin()
        {
            ...
            {
                login = new LoginDto() {Id = account.Id, Name = payload.Name, ImageName = account.ImageName, Role = account.Role, EmailCheck = account.EmailCheck};
            }
        ...
        public async Task<ActionResult> callback(string code, string state)
        {
            if (state == "aaa")
            {
                ...
                try
                {
                    ...
                    nvc.Add("client_id", "2000380875");
                    nvc.Add("client_secret", "c9f499dc8f5c120bd4534bda9475454a");
